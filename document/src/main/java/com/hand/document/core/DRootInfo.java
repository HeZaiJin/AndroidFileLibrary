 ...
 */
public class DRootInfo implements Durable, Parcelable, Comparable<DRootInfo> {
    ...
    public static final Creator<DRootInfo> CREATOR = new Creator<DRootInfo>() {
        @Override
        public DRootInfo createFromParcel(Parcel in) {
            final DRootInfo root = new DRootInfo();
            DurableUtils.readFromParcel(in, root);
            return root;
        }

        @Override
        public DRootInfo[] newArray(int size) {
            return new DRootInfo[size];
        }
    };

    public static DRootInfo fromRootsCursor(String authority, Cursor cursor) {
        final DRootInfo root = new DRootInfo();
...
//    }
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof DRootInfo) {
            DRootInfo other = (DRootInfo) o;
    ...
    @Override
    public int compareTo(DRootInfo other) {
