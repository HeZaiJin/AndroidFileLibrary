...
import static com.hand.document.provider.DocumentsContract.*;
 ...
 * {@link DocumentsContract.Document#MIME_TYPE_DIR} MIME type). Each directory represents the top
...
//        }
     ...
     */
    public @Nullable
    Bundle getDocumentMetadata(String documentId)
            throws FileNotFoundException {
    ...
    private Bundle callUnchecked(String method, String arg, Bundle extras)
        ...
        if (METHOD_EJECT_ROOT.equals(method)) {
            ...
            final String rootId = getRootId(rootUri);
            ejectRoot(rootId);
        ...
        final String documentId = getDocumentId(documentUri);
        ...
        if (METHOD_IS_CHILD_DOCUMENT.equals(method)) {
            ...
            final String childId = getDocumentId(childUri);
            ...
            final String targetId = getDocumentId(targetUri);
            ...
            final String parentSourceId = getDocumentId(parentSourceUri);
            final Uri targetUri = extras.getParcelable(DocumentsContract.EXTRA_TARGET_URI);
            final String targetId = getDocumentId(targetUri);
    ...
    protected int enforceReadPermissionInner(Uri uri, String pacakageName, IBinder callerToken)
            throws SecurityException {
        return MODE_ALLOWED;
    }

    protected int enforceWritePermissionInner(Uri uri, String pacakageName, IBinder callerToken)
            throws SecurityException {
        return MODE_ALLOWED;
    }
