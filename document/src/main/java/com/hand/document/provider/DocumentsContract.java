...
public final class DocumentsContract {
     ...
     */
    public static final String EXTRA_INITIAL_URI = "extra.INITIAL_URI";

    /**
     * Set this in a DocumentsUI intent to cause a package's own roots to be
     * excluded from the roots list.
     */
    public static final String EXTRA_EXCLUDE_SELF = "extra.EXCLUDE_SELF";
     ...
     * {@link DocumentsContract.Document#FLAG_SUPPORTS_SETTINGS} in the flags for each document that supports
     * settings.
     *
     * @see Document#FLAG_SUPPORTS_SETTINGS
     */
    public static final String
            ACTION_DOCUMENT_SETTINGS = "action.DOCUMENT_SETTINGS";

    /**
     * {@hide}
     */
    public static final String ACTION_MANAGE_DOCUMENT = "action.MANAGE_DOCUMENT";

    /**
     * {@hide}
     */
    public static final String
            ACTION_DOCUMENT_ROOT_SETTINGS = "action.DOCUMENT_ROOT_SETTINGS";
    ...
    public final static class Document {
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DocumentsContract#createWebLinkIntent(ContentResolver, Uri, Bundle)
         */
     ...
     * referenced by {@link DocumentsContract.Root#COLUMN_DOCUMENT_ID}, which can recursively
    ...
    /**
     * Build URI representing the given {@link DocumentsContract.Root#COLUMN_ROOT_ID} in a
     * document provider.
     *
     * @see #getRootId(Uri)
     */
     ...
     * rows with columns defined by {@link DocumentsContract.Document}.
     *
     * @see DocumentsProvider#queryRecentDocuments(String, String[])
     * @see #getRootId(Uri)
     */
     ...
     *                         {@link DocumentsContract.Document#MIME_TYPE_DIR}.
     ...
     * more rows with columns defined by {@link DocumentsContract.Document}.
     *
    ...
    /**
     * Extract the {@link DocumentsContract.Root#COLUMN_ROOT_ID} from the given URI.
     */
     ...
     *                    {@link DocumentsContract.Document#FLAG_SUPPORTS_THUMBNAIL} set.
...
//            rethrowIfNecessary(resolver, e);
     ...
     *
     * @param parentDocumentUri directory with {@link DocumentsContract.Document#FLAG_DIR_SUPPORTS_CREATE}
...
//            rethrowIfNecessary(resolver, e);
     ...
     *
     * @param documentUri document with {@link DocumentsContract.Document#FLAG_SUPPORTS_DELETE}
...
//            rethrowIfNecessary(resolver, e);
     ...
     *
     * @param sourceDocumentUri       document with {@link DocumentsContract.Document#FLAG_SUPPORTS_MOVE}
...
//            rethrowIfNecessary(resolver, e);
     ...
     *
     * @param documentUri       document with {@link DocumentsContract.Document#FLAG_SUPPORTS_REMOVE}
...
//            rethrowIfNecessary(resolver, e);
     ...
     *
     * @param rootUri root with {@link DocumentsContract.Root#FLAG_SUPPORTS_EJECT} to be ejected
     */
...
//            rethrowIfNecessary(resolver, e);
     ...
     * <p>
     * The {@link DocumentsContract.Path#getPath()} of the return value contains the document ID
     * of all documents along the path from the top the document tree to the
     * requested document, both inclusive.
     * <p>
     * The {@link DocumentsContract.Path#getRootId()} of the return value returns {@code null}.
     *
    ...
    public static DocumentsContract.Path findDocumentPath(ContentResolver resolver, Uri treeUri)
            throws FileNotFoundException {
...
//            rethrowIfNecessary(resolver, e);
     ...
     * the tree. The {@link DocumentsContract.Path#getPath()} of the return value contains document ID
     ...
     * {@hide}
     */
    public static DocumentsContract.Path findDocumentPath(ContentProviderClient client, Uri uri)
            throws RemoteException {
  ...
  /*  private static void rethrowIfNecessary(ContentResolver resolver, Exception e)
    ...
    public static final class Path implements Parcelable {
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || !(o instanceof DocumentsContract.Path)) {
                return false;
            }
            DocumentsContract.Path path = (DocumentsContract.Path) o;
        ...
        public static final Creator<DocumentsContract.Path> CREATOR = new Creator<DocumentsContract.Path>() {
            @Override
            public DocumentsContract.Path createFromParcel(Parcel in) {
            ...
            @Override
            public DocumentsContract.Path[] newArray(int size) {
                return new DocumentsContract.Path[size];
            }
        };
    }
}
